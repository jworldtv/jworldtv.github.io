...
{% raw %}
<button data-trolley="true" data-tpk="76KWM6X" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" onclick="window.location.href='https://trolley.link/p/76KWM6X';">
  Buy Now
</button>
